...
class CRM_Irasdonation_Form_IrasOnlineReport extends CRM_Core_Form
{
  ...
  public function postProcess()
  {
    ...
    CRM_Core_Session::setStatus('No any data to generate report', $startDate, 'success', array('expires' => 5000));
    CRM_Core_Session::setStatus('No any data to generate report', $endDate, 'success', array('expires' => 5000));
    CRM_Core_Session::setStatus('No any data to generate report', $includePrevious, 'success', array('expires' => 5000));
    return;
    //   $csvData = [];
    //   $dataBody = [];
