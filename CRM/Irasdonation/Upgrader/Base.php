 ...
 */
class CRM_Irasdonation_Upgrader_Base {

  /**
   * @var CRM_Irasdonation_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_Irasdonation_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Irasdonation_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
